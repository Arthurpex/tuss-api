...
from .models import Medicamento, Material, DiariaTaxa, Procedimento, DemaisTerminologia, TabelasDominio, GrupoEnvio, \
    FormaEnvio, UnidadeMedida, UnidadeFederacao, TipoDocumento, TermoTuss, ModeloRemuneracao
...
class MaterialSerializer(serializers.ModelSerializer):
    class Meta:
        model = Material
        fields = ['modelo', 'fabricante', 'codigo_anvisa', 'classe_risco', 'nome_tecnico']
...
class SingleTermoTussSerializer(serializers.ModelSerializer):
    ...
    def get_forma_de_envio(self, obj):
        ...
        tabela64 = FormaEnvio.objects.filter(codigo_tuss=obj.codigo_tuss, terminologia=obj.tabela).first()
