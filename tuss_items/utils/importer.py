...
from tuss_items.models import DiariaTaxa, Medicamento, Procedimento, Material, Tabela59, Tabela60, \
    Tabela79, Tabela81, Tabela63, Tabela64, Tabela87, TermoTuss, DemaisTerminologia
    ...
    if model_type in model_config:
        ...
        for chunk in csv_chunks:
            ...
            for record in records:
                ...
                termo_tuss_list.append(termo_tuss)  # Append the TermoTuss instance to the list

            with transaction.atomic():
                TermoTuss.objects.bulk_create(termo_tuss_list)  # Create TermoTuss objects
...
def import_large_csv(csv_file_path, model_type, batch_size=1000):
    ...
    for chunk in csv_chunks:
        ...
        for record in records:
            ...
            specific_model_instance = specific_model()  # Create an instance of the specific model
            ...
            main_model_list.append(main_model_instance)  # Append the main model instance to the list
            ...
            specific_model_list.append(specific_model_instance)  # Append the specific model instance to the list

        with transaction.atomic():
            main_model.objects.bulk_create(main_model_list)  # Create main model objects
            specific_model.objects.bulk_create(specific_model_list)  # Create specific model objects
